...
public class Main extends JPanel {
    ...
    public Main() {
        ...
        tabbedPane.addTab("Client", null, new panel1(),
                "Does nothing");
        tabbedPane.setMnemonicAt(0, KeyEvent.VK_1);

        JComponent panel2 = makeTextPanel("Panel #2");
        tabbedPane.addTab("Prospect", null, panel2,
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("Reverso");
        frame.setPreferredSize(new Dimension(410, 200));
